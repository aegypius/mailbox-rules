...
final class ToMatcherTest extends TestCase
{
    ...
    {
        $matcher = new ToMatcher('test@example.com');
    ...
    {
        $matcher = new ToMatcher('recipient@example.com');
    ...
    {
        $matcher = new ToMatcher('target@example.com');
    ...
    {
        $matcher = new ToMatcher('*@company.com');
    ...
    {
        $matcher = new ToMatcher('newsletter-*@example.com');
    ...
    {
        $matcher = new ToMatcher('/^support@.*/i');
    ...
    {
        $matcher = new ToMatcher('first@example.com');
    ...
    {
        $matcher = new ToMatcher('last@example.com');
    ...
    private function createMessageWithTo(array $emails): Message
    {
        ...
        $addresses = array_map(function (string $email) {
